 ...
 */
import { lwMe, lwLogout } from "./locaweb-auth.js?v=28";
...
function attachLogout() {
  ...
  // logado: esconde o "Entrar" do menu
  document.querySelectorAll('nav.site-nav a[href$="login.html"]').forEach((el) => { el.hidden = true; });
}
