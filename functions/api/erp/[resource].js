...
export async function onRequest({request,params,env}){
  ...
  if(!env.ERP_DB)return resource==="summary"?json({ok:true,setupRequired:true,demandsOpen:0,servicesToday:0,eventsWeek:0,projectsActive:0,demands:[],events:[]}):json({ok:false,error:"Banco ERP ainda não vinculado."},503);
